            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    ...
                    <div class="pull-right">
                        <?php 
                            $hasil = $lihat -> jumlah(); 
                            $total_bayar = $hasil['bayar'];
                            $pajak = $total_bayar * 0.10; // 10% tax
                            $total_setelah_pajak = $total_bayar - $pajak;
                        ?>
                        Total : Rp.<?php echo number_format($total_bayar);?>,-
                        <br/>
                        Pajak PPN (11%) : Rp.<?php echo number_format($pajak);?>,-
                        <br/>
                        Total Setelah Pajak PPN : Rp.<?php echo number_format($total_setelah_pajak);?>,-
                        <br/>
